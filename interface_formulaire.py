...
pdf.multi_cell(0, 10, txt=f"Référence : {reference}")
pdf.multi_cell(0, 10, txt=f"Institution : {institution}")
pdf.multi_cell(0, 10, txt=f"Titre : {titre}")
pdf.multi_cell(0, 10, txt=f"Nom : {nom}")
pdf.multi_cell(0, 10, txt=f"Prénom : {prenom}")
pdf.multi_cell(0, 10, txt=f"Adresse : {adresse}")
pdf.multi_cell(0, 10, txt=f"Adresse 2 : {adresse2}")
pdf.multi_cell(0, 10, txt=f"Code postal : {code_postal}")
pdf.multi_cell(0, 10, txt=f"Commune : {commune}")
pdf.multi_cell(0, 10, txt=f"Pays : {pays}")
pdf.multi_cell(0, 10, txt=f"Téléphone : {telephone}")
pdf.multi_cell(0, 10, txt=f"Email : {email}")
pdf.multi_cell(0, 10, txt=f"Langue : {langue}")
pdf.multi_cell(0, 10, txt=f"Niveau scolaire : {niveau_scolaire}")
pdf.multi_cell(0, 10, txt=f"Nombre de personnes : {nombre_personnes}")
pdf.multi_cell(0, 10, txt=f"Capacité max : {capacite_max}")
pdf.multi_cell(0, 10, txt=f"Programme : {programme}")
pdf.multi_cell(0, 10, txt=f"Détail programme : {detail_programme}")
pdf.multi_cell(0, 10, txt=f"VIP : {'Oui' if vip else 'Non'}")
pdf.multi_cell(0, 10, txt=f"Guide seul ou chauffeur-guide : {type_visite}")
pdf.multi_cell(0, 10, txt=f"Heure de début : {heure_debut}")
pdf.multi_cell(0, 10, txt=f"Lieu de début : {lieu_debut}")
pdf.multi_cell(0, 10, txt=f"Heure de fin : {heure_fin}")
pdf.multi_cell(0, 10, txt=f"Lieu de fin : {lieu_fin}")
pdf.multi_cell(0, 10, txt=f"Durée estimée : {duree}")
pdf.multi_cell(0, 10, txt=f"Tarif guidage HT : {tarif_guidage}")
pdf.multi_cell(0, 10, txt=f"TVA guidage (20%) : {tva_guidage}")
pdf.multi_cell(0, 10, txt=f"Tarif chauffeur HT : {tarif_chauffeur}")
pdf.multi_cell(0, 10, txt=f"TVA chauffeur (10%) : {tva_chauffeur}")
pdf.multi_cell(0, 10, txt=f"Tarif TTC : {tarif_ttc}")
